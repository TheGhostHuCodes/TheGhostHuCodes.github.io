...
excerpt: "The one in which I use Microsoft hardware to Linux software."
modified: 2015-01-19
tags: [Ubuntu, Azure]
---
...
other neet things that seem to be showing up on Azure (HDInsight / Machine
...
is suprizingly helpful, considering my usual subpar experience with Microsoft
